...
(cl:defmethod cl:initialize-instance :after ((m <raw_imu>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'raw_imu)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name imu_broadcast-msg:<raw_imu> is deprecated: use imu_broadcast-msg:raw_imu instead.")))
