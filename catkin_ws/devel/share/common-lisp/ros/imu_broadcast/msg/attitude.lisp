...
(cl:defmethod cl:initialize-instance :after ((m <attitude>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'attitude)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name imu_broadcast-msg:<attitude> is deprecated: use imu_broadcast-msg:attitude instead.")))

(cl:ensure-generic-function 'roll-val :lambda-list '(m))
(cl:defmethod roll-val ((m <attitude>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_broadcast-msg:roll-val is deprecated.  Use imu_broadcast-msg:roll instead.")
  (roll m))

(cl:ensure-generic-function 'pitch-val :lambda-list '(m))
(cl:defmethod pitch-val ((m <attitude>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_broadcast-msg:pitch-val is deprecated.  Use imu_broadcast-msg:pitch instead.")
  (pitch m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <attitude>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_broadcast-msg:yaw-val is deprecated.  Use imu_broadcast-msg:yaw instead.")
  (yaw m))
