...
(cl:defclass <proj_2_5d_msg> (roslisp-msg-protocol:ros-message)
  ((refPoints
    :reader refPoints
    :initarg :refPoints
    :type (cl:vector navmap-msg:point2d_t)
   :initform (cl:make-array 0 :element-type 'navmap-msg:point2d_t :initial-element (cl:make-instance 'navmap-msg:point2d_t)))
   (targetPoints
    :reader targetPoints
...
(cl:defmethod cl:initialize-instance :after ((m <proj_2_5d_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'proj_2_5d_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name navmap-msg:<proj_2_5d_msg> is deprecated: use navmap-msg:proj_2_5d_msg instead.")))

(cl:ensure-generic-function 'refPoints-val :lambda-list '(m))
(cl:defmethod refPoints-val ((m <proj_2_5d_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader navmap-msg:refPoints-val is deprecated.  Use navmap-msg:refPoints instead.")
  (refPoints m))

(cl:ensure-generic-function 'targetPoints-val :lambda-list '(m))
(cl:defmethod targetPoints-val ((m <proj_2_5d_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader navmap-msg:targetPoints-val is deprecated.  Use navmap-msg:targetPoints instead.")
  (targetPoints m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <proj_2_5d_msg>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'refPoints)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'navmap-msg:point2d_t))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<proj_2_5d_msg>)))
  ...
  (cl:format cl:nil "# Reference points~%point2d_t[] refPoints~%~%# Target points~%point2d_t[] targetPoints~%~%================================================================================~%MSG: navmap/point2d_t~%float32 x~%float32 y~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'proj_2_5d_msg)))
  "Returns full string definition for message of type 'proj_2_5d_msg"
  (cl:format cl:nil "# Reference points~%point2d_t[] refPoints~%~%# Target points~%point2d_t[] targetPoints~%~%================================================================================~%MSG: navmap/point2d_t~%float32 x~%float32 y~%~%~%"))
