...
(cl:defmethod cl:initialize-instance :after ((m <pose_estimator_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'pose_estimator_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name navmap-msg:<pose_estimator_msg> is deprecated: use navmap-msg:pose_estimator_msg instead.")))
