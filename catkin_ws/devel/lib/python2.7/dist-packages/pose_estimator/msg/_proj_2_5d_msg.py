"""autogenerated by genpy from pose_estimator/proj_2_5d_msg.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import pose_estimator.msg

class proj_2_5d_msg(genpy.Message):
  _md5sum = "79c33411ebcb4d92753eedd76f986950"
  _type = "pose_estimator/proj_2_5d_msg"
...
"""
  ...
  _slot_types = ['pose_estimator/point2d_t[]','pose_estimator/point2d_t[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = pose_estimator.msg.point2d_t()
        _x = val1
        start = end
        end += 8
