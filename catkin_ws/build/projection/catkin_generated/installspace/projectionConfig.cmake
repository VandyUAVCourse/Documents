...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'projection' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/UAVTeam/catkin_ws/install/${idir}'.  Ask the maintainer 'NavMapLeader <alex.t.meyer@vanderbilt.edu>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/UAVTeam/catkin_ws/install/lib;/opt/ros/hydro/lib)
