...
PoseUKF::PoseUKF() {
    ...
    *initCov = Matrix6d::Identity() * mProcessError;
    ...
    mPub = mN.advertise<navmap::pose_ukf_msg>("pose_ukf", 1000);
 ...
 */
void PoseUKF::pose_est_receiver(const navmap::pose_ukf_msgConstPtr& msg) {
 ...
 */
void PoseUKF::slam_receiver(const navmap::pose_ukf_msgConstPtr& msg) {
