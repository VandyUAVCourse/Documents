...
struct GridLineTraversalLine {
  int     num_points;
  IVector2  points[GRIDTRAVERSAL_MAXPOINTS];
};

struct GridLineTraversal {
  inline static void gridLine( IVector2 start, IVector2 end, GridLineTraversalLine *line ) ;
  inline static void gridLineCore( IVector2 start, IVector2 end, GridLineTraversalLine *line ) ;

};

void GridLineTraversal::gridLineCore( IVector2 start, IVector2 end, GridLineTraversalLine *line )
{
...
void GridLineTraversal::gridLine( IVector2 start, IVector2 end, GridLineTraversalLine *line ) {
  int i,j;
  int half;
  IVector2 v;
